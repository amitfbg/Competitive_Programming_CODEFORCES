...
public class A {
	...
	private static void solve() {
        /* 
        Here the value changes when we have 0 at the end
        so difference value will be 10 or 100 or 1000 ..... depends the number of digits we have as input
        so the answer will be length of the input
        e.g. 90
        different value will be for this is
        1 and 10 only
        10 when last digit will be 0
        else 1
        */
